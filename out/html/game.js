...
window.get_taxes_final = function(taxes_in_question) { 
    ...
    var lower_pop = Q.workers_population_percent + Q.rural_workers_population_percent + Q.farmhand_population_percent + (farmer_population_percent * 0.8);
    var middle_pop = (Q.old_middle_population_percent + Q.new_middle_population_percent)*0.9 + (farmer_population_percent)*0.2;
